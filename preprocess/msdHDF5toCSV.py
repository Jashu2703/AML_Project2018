...
def main():
    outputFile1 = open('E://Engineering//7th_sem//AML//Project//AML_Project2018//data//SongCSV.csv', 'w')
    csvRowString = ""
    ...
    basedir = "E://Engineering//7th_sem//AML//Project//AML_Project2018//data//MillionSongSubset" # "." As the default means the current directory
